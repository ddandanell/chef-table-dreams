        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <ScrollReveal>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Button 
                size="lg" 
                className="bg-white text-foreground hover:bg-white/90 transition-transform hover:-translate-y-1 group"
              >
              ...
              <Button 
                size="lg" 
                className="bg-white text-foreground hover:bg-white/90 transition-transform hover:-translate-y-1"
                asChild
              >
                <a 
